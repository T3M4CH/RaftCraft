Shader "DELTation/Toon Shader (No Shadows)"
{
    Properties
    {
        [MainTexture]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderInput.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderForwardPass_AppData.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderInput.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderShadowCasterPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderInput.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderMetaPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderInput.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderDepthOnlyPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderInput.hlsl"
            #include "Packages/com.gtap.gamecore.toonshader/Runtime/Shaders/ToonShaderDepthNormalsPass.hlsl"
            ENDHLSL
        }
    }
